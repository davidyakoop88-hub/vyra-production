...
: "${VYRA_TIKTOK_BRIDGE_IMAGE:?Previous tiktok-bridge image missing}"
export VYRA_API_IMAGE VYRA_WEB_IMAGE VYRA_TIKTOK_BRIDGE_IMAGE
docker compose -f docker-compose.production.yml up -d --no-deps api web tiktok-connection-manager
