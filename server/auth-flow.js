...
//
// TAKET ÄR INTE ENDA SPÄRREN, och det är avsiktligt. `/api/auth/email/send-verification` saknades i
// listan över hastighetsbegränsade auth-rutter i index.js — bara `email/verify` stod där. Att sluta
// radera gamla token utan att täppa det hade bytt en irriterande bugg mot en väg att skicka obegränsat
// med mejl och fylla på rader. Rutten står numera i listan, så antalet UTSKICK begränsas per IP och
// antalet LEVANDE token per konto.
