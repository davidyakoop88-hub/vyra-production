...
const BAS = () => ({
  ...
  PAYPAL_CLIENT_ID: 'A'.repeat(20) + crypto.randomUUID().replace(/-/g,''),
  PAYPAL_CLIENT_SECRET: 'E'.repeat(20) + crypto.randomUUID().replace(/-/g,''),
  PAYPAL_ENV: 'live',
  PAYPAL_WEBHOOK_ID: '7VL31387MH8558935',
  PAYPAL_PLAN_MONTHLY: 'P-1N359441EG117004VNKPKILY',
  PAYPAL_PLAN_MONTHLY_TRIAL: 'P-7UY349153P1818424NKPKG2A',
