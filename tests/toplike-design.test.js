...
test('fresh asset versions prevent a cached retired design from surviving reload', () => {
  ...
  // Bumpad EN GANG TILL, samma dag (8b60613 "Bump media loader after today feature updates" och
  // det efterfoljande stadstadet av dess ostrukturerade suffix): media.js gick vidare till -2,
  // orelaterat till toplike-kedjan ovan.
