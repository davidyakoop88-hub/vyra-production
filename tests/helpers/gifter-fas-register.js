...
//
// gifter-fas.js är en IIFE över `window` och går inte att `require`. Men registret — FASER,
...
// gifter-fas.js slår igenom i proven direkt.
const fs = require('fs'), path = require('path'), vm = require('vm');

const KALLA = path.join(__dirname, '..', '..', 'gifter-fas.js');
...
vm.runInNewContext(fs.readFileSync(KALLA, 'utf8'), root, { filename: 'gifter-fas.js' });
...
const { PREFIX, FASER, KORTASTE_VISNING } = root.VyraGifterFas;
