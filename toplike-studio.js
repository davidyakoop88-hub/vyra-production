(function () {
  ...
  bind = function () {
    ...
    // textOutlineWidth/Color — så sparade layouter ser likadana ut; det är kontrollerna
    // som slogs ihop, efter att panel-inga-dubbletter-provet fällde dem som dubbletter.
