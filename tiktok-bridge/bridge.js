...
if (require.main === module) {
  ...
  function connect() {
    ...
    /* GUARDIAN ENTRY — FORBEREDD, INTE AKTIVERAD.
       ===========================================================================================
       ...
       listorna i SAMMA andring. Klientsidan ar redan klar — window.triggerGuardianWelcome finns,
       ar koad, och vantar bara pa ett event.
       ...
       traff finns i molnets fyra listor. En utkommenterad rad raknas — provet lasar text, inte
       ...
       //   sendEvent(TYP, {
       //     ...N.baseUser(data),
       //     weekNumber: N.number(data?.FALT_TBD_VECKA, 53),
       //   }, data);
       // });
