...
test('cloud event preserves canonical identity and bounded values',()=>{
  ...
  // en andra gang samma dag nar isFollower/isSubscriber tillkom — ocksa da med flit. Och en TREDJE
  // gang 2026-09-07, nar toUserId/tillVarden lades till for medvardsgavorna (#360). Tre fall pa tva
  // dygn: helformen ar inte en olagenhet, den ar det enda som gor varje tillagg medvetet.
