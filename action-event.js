(() => {
  ...
  const actionTypes=[['overlay','Visa overlay/widget'],['animation','Visa animation'],['picture','Visa bild/GIF'],['audio','Spela ljud'],['video','Spela video'],['alert','Visa alert'],['tts','Läs text (TTS)'],['chat','Skicka chatbotmeddelande'],['spotify','Spela Spotify'],['obsScene','Byt OBS-scen'],['obsSource','Aktivera OBS-källa'],['webhook','Anropa webhook']];
