...
/* TRAPPAN UTGAR FRAN STREAMERNS EGET MINIMUM, inte fran hardkodade 100 och 1000. Davids ord:
   "gavan ska funka pa anvandare som bestammer minimum" och "borjar fran 1 coins och uppat".
   En kanal dar 100 mynt ar stort och en dar 100 mynt ar vardagsmat kan omojligt dela siffror.
   Firande vid tio ganger minimum, final vid hundra ganger. Med fwMin=1 blir det 10 och 100,
   med fwMin=10 blir det 100 och 1000 — de varden som matningen av sandningen 2026-09-18 gav.
   RAKNAS PER WIDGET. Flera fyrverkerier med olika fwMin ar en avsiktlig funktion (se
...
const fwStyrkaOf=(input,w)=>{const d=input&&typeof input==='object'?input:{combo:input};
 ...
 const min=Math.max(1,Number(w&&w.fwMin)||1);
 return varde>=min*100?100:varde>=min*10?10:1};
