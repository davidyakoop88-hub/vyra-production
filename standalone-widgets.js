...
(function () {
  const CATALOG = [
    ...
    // Ett blandat, arbetsyte-konfigurerbart poäng per tittare (points-runtime.js) — INTE separata
    // råräknare för likes eller diamanter. Heter därför "Top Points", inte "Top Like"/"Top Coins":
    // de två kräver antingen per-widget-intjäningstakter eller egna register som inte finns än.
    // Tre presets, en fil (public/widgets/top-points.html), samma mönster som Goal · Image Frame.
    ['top-points', 'Top Points', 'Poängranking · livedata från points-runtime.js, tre stilar', [['prism','Top Points · Prism','Ornamenterad ring, lista på 10'],['voltage','Top Points · Voltage','Neon energiring, lista på 5'],['basic','Top Points · Basic','Minimal guldring, lista på 4']]],
  ];
