...
(() => {
  ...
  const FEATURES = [
    ...
    { icon: '⭐', title: 'Poängsystem', where: 'Action & Event → Poängsystem', body: 'Tittare tjänar poäng automatiskt bara genom att vara aktiva (gåvor, delningar, likes, tid i chatten). Poängen kan spenderas på events du skapar (t.ex. TTS eller en overlay-effekt) och ger tittarna nivåer ju mer de tjänat totalt.' },
    ...
    { icon: '🎬', title: 'Vip-paket', where: 'Vip-paket', badge: 'PRO', body: 'Färdiga, tema-paketerade video-effekter (t.ex. Koi Pearl Lagoon, Masquerade Ball) du kan lägga direkt på din overlay-canvas — praktiskt för battle-boosts och liknande visuella effekter.' },
    ...
    { icon: '🎥', title: 'OBS-koppling', where: 'Action & Event → OBS-anslutning', body: 'Låt Actions byta OBS-scen eller aktivera/inaktivera en OBS-källa automatiskt, t.ex. vid en stor gåva. Kräver VYRA Desktop (skrivbordsappen) och att OBS WebSocket Server är påslaget i OBS.' },
    { icon: '📊', title: 'Analytics', where: 'Analytics', body: 'Se din tillväxt över tid, dina största supportrar, och (efter några sändningar) rekommendationer för bästa tid att gå live baserat på dina egna tidigare sändningar.' }
  ];
