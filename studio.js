...
// EN SANNING OM SANDNINGEN. Basvyn bar till 2026-08-20 fyra kort — TITTARE/LIKES/GAVOR/INTAKT —
// som overview-premium.js ersatte med toppgivarraden. Bada fanns kvar samtidigt, och basvyn hann
// ritas innan premiumbunten laddat: varje sidladdning blinkade forbi en vy som pastod nagot annat
// om samma sandning, med ett INTAKT-kort vi medvetet gatt ifran (diamanter ar inte pengar).
// Basvyn bar nu SAMMA tomma toppgivarrad, sa de tva vyerna kan inte langre saga emot varandra —
// och faller premiumbunten star anvandaren kvar med nagot arligt i stallet for nagot foraldrat.
function home(){return `<div class="oversikt-sken" aria-hidden="true"><i></i><i></i><i></i></div><div class="toppgivare" data-toppgivare><div class="toppgivare-rad toppgivare-skelett" aria-hidden="true"><span></span><span></span><span></span><span></span><span></span></div><p class="toppgivare-tom">Toppgivarna visas här under riktig LIVE.</p></div><div class="home-grid"><article class="card chart-card"><div class="card-head"><h2>Live-engagemang</h2><span>Ingen livedata ännu</span></div>${chart()}</article><article class="card activity"><div class="card-head"><h2>Senaste events</h2></div><p>Händelser visas här under din riktiga TikTok LIVE.</p></article><article class="card quick"><button data-go="editor"><b>◫ Skapa overlay</b><span>Öppna editorn →</span></button><button data-go="flows"><b>⌁ Ny automation</b><span>Koppla event →</span></button><button id="testGift"><b>◇ Skicka testgåva</b><span>Visa i overlay →</span></button></article></div>`}
...
function analytics(){return `<div class="analytics-grid statistics-page" data-statistics-page><header class="card statistics-head"><div><small>LIVEHISTORIK</small><h2>Statistik</h2><p>Riktiga siffror från dina sändningar med VYRA Desktop.</p></div><div class="statistics-periods" aria-label="Välj period"><button data-stats-period="7d">7 dagar</button><button class="active" data-stats-period="30d">30 dagar</button><button data-stats-period="90d">90 dagar</button><button data-stats-period="all">All tid</button></div></header><p class="card statistics-status" data-stats-status role="status">Hämtar din statistik…</p><div class="statistics-totals"><article class="card"><small>GÅVOR</small><strong data-stats-total="gifts">–</strong></article><article class="card"><small>DIAMANTER</small><strong data-stats-total="diamonds">–</strong></article><article class="card"><small>LIKES</small><strong data-stats-total="likes">–</strong></article></div><div class="statistics-grid"><article class="card statistics-chart-card"><div class="statistics-card-head"><div><small>UTVECKLING</small><h3>Aktivitet per livedag</h3></div><span>Diamanter</span></div><div class="statistics-chart" data-stats-chart><div class="statistics-empty" data-tom="statistik-tillvaxt">Ingen livedata ännu. Gå live med VYRA Desktop så ritas din tillväxt här dag för dag.</div></div></article><article class="card statistics-supporters-card"><div class="statistics-card-head"><div><small>COMMUNITY</small><h3>Toppsupportrar</h3></div><span>All tid</span></div><ol class="statistics-supporters" data-stats-supporters><li class="statistics-empty" data-tom="statistik-topp">Inga supportrar att visa ännu. Efter din första livesändning listas dina största gåvogivare här.</li></ol></article></div></div>`}
